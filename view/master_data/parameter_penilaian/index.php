              ...
              <table class="table border table-md text-wrap customize-table mb-0 align-middle">
                <thead class="text-dark fs-3">
                  <tr>
                    ...
                    <th><h6 class="fs-3 fw-semibold mb-0">Keterangan</h6></th>
                    <th><h6 class="fs-3 fw-semibold mb-0">Bobot</h6></th>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <td>
                        <p class="fs-3 fw-semibold mb-0"><?= $value['beasiswa']; ?></p>
                      </td>
                      <td>
                        <p class="mb-0 fw-normal fs-3"><?= $value['kriteria']; ?></p>
                      </td>
                      <td>
                        <p class="mb-0 fw-normal fs-3"><?= $value['keterangan']; ?></p>  
                      </td>
                      <td>
                        <p class="mb-0 fw-normal fs-3"><?= $value['bobot']; ?></p>  
                      </td>
                      <td>
