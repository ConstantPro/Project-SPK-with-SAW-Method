            ...
            <div class="table-responsive rounded-2 mb-4">
              <table class="table border table-md text-nowrap customize-table mb-0 align-middle">
                <thead class="text-dark fs-3">
                  <tr>
                    <th><h6 class="fs-3 fw-semibold mb-0">Kode</h6></th>
                    <th><h6 class="fs-3 fw-semibold mb-0">Nama</h6></th>
                    <th><h6 class="fs-3 fw-semibold mb-0">Sifat</h6></th>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <td>
                        <p class="fs-3 fw-semibold mb-0"><?= $value['kode']; ?></p>
                      </td>
                      <td>
                        <p class="mb-0 fw-normal fs-3"><?= $value['nama']; ?></p>
                      </td>
                      <td>
                        <p class="mb-0 fw-normal fs-3"><?= $value['sifat']; ?></p>  
                      </td>
                      <td>
