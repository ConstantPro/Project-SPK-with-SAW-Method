<?php
  ...
  $value = mysqli_fetch_assoc(get_data_pengajuan_beasiswa($_GET['id']));
  $nilai = get_data_parameter_penilaian_for_pengajuan($value['kriteria_id'], $value['beasiswa_id']);
                            ...
                            <div class="col">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select" id="mahasiswa_id" name="mahasiswa_id">
                                        ...
                                        <option value="<?= $val['id']?>" <?= $value['mahasiswa_id'] == $val['id'] ? 'selected' : '' ?>><?= $val['nama']; ?> (<?= $val['nim']?>)</option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select" id="nilai" name="nilai">
                                        ...
                                        <option value="<?= $val['id']?>" <?= $value['nilai'] == $val['id'] ? 'selected' : '' ?>><?= $val['keterangan']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        html += `<option value="${value.bobot}">${value.keterangan}</option>`
                    })
                    $('#nilai').html(html);
                }
            })
